...
import WebflowIcon from '@/components/WebflowIcon.vue'
import VueJsIcon from '@/components/VueJsIcon.vue'
...
const projectTypes = [
  ...
  { title: 'Brand Site', value: 'brand-site' },
...
<template>
  <header class="w-full sticky top-0 bg-[#1E1E1E] z-20">
    <div class="flex gap-2 p-4 max-w-[64rem] w-full m-auto text-gray-100">
      <a
  ...
  <section class="flex flex-col gap-4 justify-center m-auto h-full">
    <div class="flex flex-col w-full md:h-auto items-center bg-[#1E1E1E] relative overflow-hidden">
      <h1
        class="text-2xl font-bold text-center text-gray-100 bg-blend-lighten -mb-16 md:-mb-36 z-10 pt-16"
      >
        Hi there! I'm Sairaj
      ...
      />
      <img src="/halo-ellipsis.png" alt="" class="absolute w-[20rem] md:w-[46rem] bottom-16" />
      <RouterLink
        to="#projects"
        class="button flex gap-2 items-center absolute z-10 bottom-4 md:bottom-8"
      >
        <ArrowDown />
        Check out my work</RouterLink
      >
      <!-- <FigmaIcon
        class="absolute aspect-square w-28 bottom-[calc(50%-8rem)] z-10 bg-white p-6 shadow-2xl left-[calc(50%-16rem)] rounded-4xl -translate-x-1/2"
      />
      <WebflowIcon
        class="absolute aspect-square w-28 bottom-1/2 z-10 bg-white p-6 shadow-2xl right-[calc(50%-24rem)] rounded-4xl -translate-x-1/2"
      />
      <VueJsIcon
        class="absolute aspect-square w-28 bottom-[calc(50%-16rem)] z-10 bg-white p-6 shadow-2xl right-[calc(50%-16rem)] rounded-4xl -translate-x-1/2"
      /> -->
    </div>
  </section>
